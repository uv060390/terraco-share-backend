                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="lastNameLabel" class="form-label">Location</label>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="firstNameLabel" class="form-label">Discount</label>
                                        <input type="text" class="form-control" name="firstName"
                                            id="firstNameLabel" />
                                    </div>
                                    <!-- End Form -->
                                ...
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="lastNameLabel" class="form-label">Area</label>
                                        <input type="text" class="form-control" name="lastName"
                                            id="lastNameLabel" />
                                    </div>
                                    <!-- End Form -->
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="firstNameLabel" class="form-label">Estimate</label>
                                        <input type="text" class="form-control" name="firstName"
                                            id="firstNameLabel" />
                                    </div>
                                    <!-- End Form -->
                                ...
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="lastNameLabel" class="form-label">Min investment</label>
                                        <input type="text" class="form-control" name="lastName"
                                            id="lastNameLabel" />
                                    </div>
                                    <!-- End Form -->
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="firstNameLabel" class="form-label">Description</label>
                                        <input type="text" class="form-control" name="firstName"
                                            id="firstNameLabel" />
                                    </div>
                                    <!-- End Form -->
                                ...
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="lastNameLabel" class="form-label">Bedrooms</label>
                                        <input type="text" class="form-control" name="lastName"
                                            id="lastNameLabel" />
                                    </div>
                                    <!-- End Form -->
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="firstNameLabel" class="form-label">Bathrooms</label>
                                        <input type="text" class="form-control" name="firstName"
                                            id="firstNameLabel" />
                                    </div>
                                    <!-- End Form -->
                                ...
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="lastNameLabel" class="form-label">Super Built-Up Area</label>
                                        <input type="text" class="form-control" name="lastName"
                                            id="lastNameLabel" />
                                    </div>
                                    <!-- End Form -->
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="firstNameLabel" class="form-label">Developer</label>
                                        <input type="text" class="form-control" name="firstName"
                                            id="firstNameLabel" />
                                    </div>
                                    <!-- End Form -->
                                ...
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="lastNameLabel" class="form-label">Project</label>
                                        <input type="text" class="form-control" name="lastName"
                                            id="lastNameLabel" />
                                    </div>
                                    <!-- End Form -->
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="firstNameLabel" class="form-label">Status</label>
                                        <input type="text" class="form-control" name="firstName"
                                            id="firstNameLabel" />
                                    </div>
                                    <!-- End Form -->
                                ...
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="lastNameLabel" class="form-label">broucher</label>
                                        <input type="text" class="form-control" name="lastName"
                                            id="lastNameLabel" />
                                    </div>
                                    <!-- End Form -->
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="firstNameLabel" class="form-label">Price-Breakup</label>
                                        <input type="text" class="form-control" name="firstName"
                                            id="firstNameLabel" />
                                    </div>
                                    <!-- End Form -->
                                ...
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="lastNameLabel" class="form-label">Possession-Date</label>
                                        <input type="text" class="form-control" name="lastName"
                                            id="lastNameLabel" />
                                    </div>
                                    <!-- End Form -->
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="firstNameLabel" class="form-label">Possession Date</label>
                                        <input type="text" class="form-control" name="firstName"
                                            id="firstNameLabel" />
                                    </div>
                                    <!-- End Form -->
                                ...
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="lastNameLabel" class="form-label">Booking Date</label>
                                        <input type="text" class="form-control" name="lastName"
                                            id="lastNameLabel" />
                                    </div>
                                    <!-- End Form -->
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="firstNameLabel" class="form-label">RERA-ID</label>
                                        <input type="text" class="form-control" name="firstName"
                                            id="firstNameLabel" />
                                    </div>
                                    <!-- End Form -->
                                ...
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="lastNameLabel" class="form-label">Address</label>
                                        <input type="text" class="form-control" name="lastName"
                                            id="lastNameLabel" />
                                    </div>
                                    <!-- End Form -->
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="firstNameLabel" class="form-label">Payment-Structure</label>
                                        <input type="text" class="form-control" name="firstName"
                                            id="firstNameLabel" />
                                    </div>
                                    <!-- End Form -->
                                ...
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="lastNameLabel" class="form-label">Attached-Title</label>
                                        <input type="text" class="form-control" name="lastName"
                                            id="lastNameLabel" />
                                    </div>
                                    <!-- End Form -->
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="firstNameLabel" class="form-label">Address-Description</label>
                                        <input type="text" class="form-control" name="firstName"
                                            id="firstNameLabel" />
                                    </div>
                                    <!-- End Form -->
                                ...
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="lastNameLabel" class="form-label">Address-File</label>
                                        <input type="text" class="form-control" name="lastName"
                                            id="lastNameLabel" />
                                    </div>
                                    <!-- End Form -->
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="firstNameLabel" class="form-label">Image</label>
