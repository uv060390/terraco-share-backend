...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl footer-offset">
    ...
    <main id="content" role="main" class="main">
        <form id="listing-form" action="{{ route('admin.listing.store') }}" method="POST"
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col-sm mb-2 mb-sm-0">
                            <h1 class="page-header-title">Create List</h1>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <!-- Form -->
                                        <div class="mb-4">
                                            <label for="locationlabel" class="form-label">URL</label>
                                    ...
                                    <div class="col-sm-6">
                                        <!-- Form -->
                                        <div class="mb-4">
                                            <label for="locationlabel" class="form-label">Location</label>
                                        ...
                                        <table class="table table-bordered" id="dynamicAddRemove">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="amenities[0][icon]"
                                                        placeholder="Enter icon" class="form-control" /></td>
