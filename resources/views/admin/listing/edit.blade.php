...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl footer-offset">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" name="discount"
                                                value="{{ $listing->discount }}" id="discount" />
                                        </div>
                                        <!-- End Form -->
                                    </div>
                                    <!-- End Col -->
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" name="estimate"
                                                value="{{ $listing->estimate }}" id="estimate" />
                                        </div>
                                        <!-- End Form -->
                                    </div>
                                    <!-- End Col -->
                                    ...
                                    <div class="col-sm-6">
                                        <!-- Form -->
                                        <div class="mb-4">
                                            <label for="mini_investment" class="form-label">Min investment</label>
                                            <input type="text" class="form-control" name="mini_investment"
                                                value="{{ $listing->mini_investment }}" id="mini_investment" />
                                        </div>
                                        <!-- End Form -->
                                    </div>
                                    <!-- End Col -->
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" name="description"
                                                value="{{ $listing->description }}" id="description" />
                                        </div>
                                        <!-- End Form -->
                                    </div>
                                    <!-- End Col -->
                                    ...
                                    <div class="col-sm-6">
                                        <!-- Form -->
                                        <div class="mb-4">
                                            <label for="no_of_bedrooms" class="form-label">Bedrooms</label>
                                            <input type="text" class="form-control" name="no_of_bedrooms"
                                                value="{{ $listing->no_of_bedrooms }}" id="no_of_bedrooms" />
                                        </div>
                                        <!-- End Form -->
                                    </div>
                                    <!-- End Col -->
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <!-- Form -->
                                        <div class="mb-4">
                                            <label for="no_of_bathrooms" class="form-label">Bathrooms</label>
                                            <input type="text" class="form-control" name="no_of_bathrooms"
                                                value="{{ $listing->no_of_bathrooms }}" id="no_of_bathrooms" />
                                        </div>
                                        <!-- End Form -->
                                    </div>
                                    <!-- End Col -->
                                    ...
                                    <div class="col-sm-6">
                                        <!-- Form -->
                                        <div class="mb-4">
                                            <label for="super_builtup_area" class="form-label">Super Built-Up
                                                Area</label>
                                            <input type="text" class="form-control" name="super_builtup_area"
                                                value="{{ $listing->super_builtup_area }}" id="super_builtup_area" />
                                        </div>
                                        <!-- End Form -->
                                    </div>
                                    <!-- End Col -->
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" name="developer"
                                                value="{{ $listing->developer }}" id="developer" />
                                        </div>
                                        <!-- End Form -->
                                    </div>
                                    <!-- End Col -->
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" name="project"
                                                value="{{ $listing->project }}" id="project" />
                                        </div>
                                        <!-- End Form -->
                                    </div>
                                    <!-- End Col -->
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select class="form-select" name="status" id="status"
                                                value="{{ $listing->status }}" aria-label=" Default select example">
                                                <option>Draft</option>
                                    ...
                                    <div class="col-sm-6">
                                        <!-- Form -->
                                        <div class="mb-4">
                                            <label for="broucher" class="form-label">broucher</label>
                                            <input type="file" class="form-control" name="broucher"
                                                value="{{ $listing->broucher }}" id="broucher" />
                                        </div>
                                        <!-- End Form -->
                                    </div>
                                    <!-- End Col -->
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <!-- Form -->
                                        <div class="mb-4">
                                            <label for="price_breakup" class="form-label">Price-Breakup</label>
                                            <input type="text" class="form-control" name="price_breakup"
                                                value="{{ $listing->price_breakup }}" id="price_breakup" />
                                        </div>
                                        <!-- End Form -->
                                    </div>
                                    <!-- End Col -->
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="date" class="form-control" name="possession_date"
                                                value="{{ $listing->possession_date }}" id="possession_date" />
                                        </div>
                                        <!-- End Form -->
                                    </div>
                                    <!-- End Col -->
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="date" class="form-control" name="booking_date"
                                                value="{{ $listing->booking_date }}" id="booking_date" />
                                        </div>
                                        <!-- End Form -->
                                    </div>
                                    <!-- End Col -->
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" name="rera_id"
                                                value="{{ $listing->rera_id }}" id="rera_id" />
                                        </div>
                                        <!-- End Form -->
                                    </div>
                                    <!-- End Col -->
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" name="address"
                                                value="{{ $listing->address }}" id="address" />
                                        </div>
                                        <!-- End Form -->
                                    </div>
                                    <!-- End Col -->
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <!-- Form -->
                                        <div class="mb-4">
                                            <label for="payment_structure"
                                                class="form-label">Payment-Structure</label>
                                            <input type="text" class="form-control" name="payment_structure"
                                                value="{{ $listing->payment_structure }}" id="payment_structure" />
                                        </div>
                                        <!-- End Form -->
                                    </div>
                                    <!-- End Col -->
                                    ...
                                    <div class="col-sm-6">
                                        <!-- Form -->
                                        <div class="mb-4">
                                            <label for="attached_title" class="form-label">Attached-Title</label>
                                            <input type="text" class="form-control" name="attached_title"
                                                value="{{ $listing->attached_title }}" id="attached_title" />
                                        </div>
                                        <!-- End Form -->
                                    </div>
                                    <!-- End Col -->
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-4">
                                            <label for="address_description"
                                                class="form-label">Address-Description</label>
                                            <input type="text" class="form-control" name="address_description"
                                                value="{{ $listing->address_description }}"
                                    ...
                                    <div class="col-sm-6">
                                        <!-- Form -->
                                        <div class="mb-4">
                                            <label for="address_file" class="form-label">Address-File</label>
                                            <input type="file" class="form-control" name="address_file"
                                                value="{{ $listing->address_file }}" id="address_file" />
                                        </div>
                                        <!-- End Form -->
                                    </div>
                                    <!-- End Col -->
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <!-- Form -->
                                        <div class="mb-4">
                                            {{-- <div id="image-preview" class="img-preview" style="background: url({{ $data->featured_image ? asset('assets/upload/listing/'.$data->featured_image):asset('assets/upload/noimage.png') }});"> --}}

                                            <label for="featured_image" class="form-label">Image</label>
                                            <input type="file" class="form-control" name="featured_image"
                                                value="{{ $listing->featured_image }}" id="featured_image" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="card mb-3 mb-lg-5">
                                        ...
                                        <div class="card-header">
                                            <h4 class="card-header-title">Amentities</h4>
                                        </div>
                                        {{-- <div class="container"> --}}
                                        <div class="row">
                                            <table class="table table-bordered" id="dynamicAddRemove">
                                                ...
                                                @if (count($listing->amenities) > 0)
                                                    @foreach ($listing->amenities as $key => $value)
                                                        <tr>
                                                            <td><input type="text"
                                                                    name="amenities[{{ $key }}][name]"
                                                                    value="{{ $value->name }}"
                                                            ...
                                                            <td><input type="text"
                                                                    ...
                                                                    value="{{ $value->icon }}"
                                                                    placeholder="Enter icon" class="form-control" />
                                                            </td>
                                                            @if ($key == 0)
                                                                <td><button type="button" name="add"
                                                                        id="add-btn" class="btn btn-success ">Add
                                                                        More</button></td>
                                                            @else
                                                ...
                                                @else
                                                    <tr>
                                                        <td><input type="text" name="amenities[0][name]"
                                                                value="" placeholder="Enter name"
                                                                class="form-control" />
                                                        </td>
                                                        <td><input type="text" name="amenities[0][icon]"
                                                                value="" placeholder="Enter icon"
                                                                class="form-control" />
                                                        </td>
    ...
    <script type="text/javascript">
        let i = parseInt("{{ count($listing->amenities) }}") - 1;
        $("#add-btn").click(function() {
            i++;
            $("#dynamicAddRemove").append('<tr><td><input type="text" name="amenities[' + i +
                '][name]" placeholder="Enter name" class="form-control" /></td><td><input type="text" name="amenities[' +
                i +
                '][icon]" placeholder="Enter icon" class="form-control" /></td><td><button type="button" class="btn btn-danger remove-tr">Remove</button></td></tr>'
            );
        });
